...
$(function(){"use strict";function p(a){e.height()<b.height()?e.height(b.height()):b.height()<e.height()&&b.height()>parseInt(e.css("min-height").replace("px",""),10)&&e.height(b.height()),$(".news-content:nth-child("+a+")").height()>e.height()&&e.height($(".news-content:nth-child("+a+")").height()+i)}function q(){k=setInterval(function(){$(".select").index()+1===f?d.trigger("click"):$(".select").next(":not(.highlight)").trigger("click")},j)}function r(){c.on("click",function(){for(c.removeClass("select"),$(this).addClass("select"),l=$(this).prevAll(),m=0,o=0;o<l.length;o+=1)m+=$(l[o]).height(),m+=g,m+=h;a.css({top:m,height:$(this).height()+g}),n=$(this).index()+1,$(".news-content:nth-child("+n+")").siblings().removeClass("top-content"),$(".news-content:nth-child("+n+")").addClass("top-content"),clearInterval(k),q(),p(n)})}function s(){$(window).resize(function(){clearInterval(k),$(".select").trigger("click")})}var a,b=$(".headlines"),c=$(".headlines li"),d=$(".headlines li:nth-child(1)"),e=$(".news-preview"),f=$(".headlines").children(":not(.highlight)").length,g=parseInt(d.css("padding-top").replace("px",""),10)+parseInt(d.css("padding-bottom").replace("px",""),10),h=parseInt(d.css("margin-top").replace("px",""),10)+parseInt(d.css("margin-bottom").replace("px",""),10),i=parseInt($(".news-content").css("padding-top").replace("px",""),10)+parseInt($(".news-content").css("padding-bottom").replace("px",""),10),j=5e3,k=null,l=null,m=null,n=1,o=null;b.append('<li class="highlight nh-anim"></li>'),a=$(".highlight"),c.addClass("nh-anim"),$(".news-content").on("mouseover",function(){clearInterval(k)}),$(".news-content").on("mouseout",function(){q()}),r(),s(),$(".select").trigger("click")});